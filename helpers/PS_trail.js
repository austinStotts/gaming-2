...
class ParticleSystem {
  constructor(params) {
    const uniforms = {
        diffuseTexture: {
            value: new THREE.TextureLoader().load('https://sl-gaming.s3.amazonaws.com/pvpassets/dot.png')
        },
        pointMultiplier: {
    ...
    this._geometry.setAttribute('size', new THREE.Float32BufferAttribute([], 5));
...
//   }
  ...
  _AddParticles(timeElapsed) {
    ...
    for (let i = 0; i < n; i++) {
      ...
      // this.parent.getWorldPosition(p0)
      const life = 0.25;
      this._particles.push({
          ...
          new THREE.Vector3().copy(this.parent.userData.body.velocity).negate()
